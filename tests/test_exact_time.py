...
test_time = dt.datetime(2018, 1, 1, 12, 0)

# TODO: convert into dict
cases = [
    ("послать презентацию завтра в 10 утра", "завтра в 10 утра", dt.datetime(2018, 1, 2, 10, 0)),
    ...
    ("напомни погладить в 10", "в 10", dt.datetime(2018, 1, 1, 10, 0)),
    (
    ...
    ("23 мая в 15-10 на почту", "23 мая в 15-10", dt.datetime(2018, 5, 23, 15, 10)),
    (
    ...
    ("электричка в 6 утра", "в 6 утра", dt.datetime(2018, 1, 1, 6, 0)),
    ("электричка в 2 ночи", "в 2 ночи", dt.datetime(2018, 1, 1, 2, 0)),
    ("электричка в 2 дня", "в 2 дня", dt.datetime(2018, 1, 1, 14, 0)),
    ("завтра в 10 утра накормить кошку", "завтра в 10 утра", dt.datetime(2018, 1, 2, 10, 0)),
    ...
    ("сходить в магазин сегодня вечером", "сегодня вечером", dt.datetime(2018, 1, 1, 19, 0)),
    ("сходить в магазин завтра днём", "завтра днём", dt.datetime(2018, 1, 2, 14, 0)),
    # привести даты в порядок, т.е. если дата в будущем или задана неточно
    # либо задана как 10 часов, хотя имеется ввиду 22 часа
]


@pytest.mark.parametrize("case,case_time,moment", cases)
def test_cases(case, case_time, moment):
